...
function GetInvolved() {
  return (
    <div className="bg-gray-50 p-8 w-[90%] mx-auto rounded-md">
        
        <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-5xl lg:text-6xl">Get Involved? Interested in collaboration?</h1>
        ...
        <p className="mb-4">
            ...
            education to your members, we would love to work with you to co-host events.
        </p>
        <p className=" mb-4">
