        ...
        <div className="hero max-w-[85rem] mx-auto bg-gray-50 px-4 sm:px-6 lg:px-8 mt-10 rounded-md">
            ...
            <div className="flex items-center justify-center h-1/2 flex-col md:flex-row">
                ...
                <div className=" md:w-1/2">
                    ...
                    <div className="mt-6 icons lg:mt-12 flex gap-x-3 items-center  justify-start">
                        <svg
                            viewBox="0 0 960 1000"
                            fill="currentColor"
                            className="twitter w-10 h-10 transition-all duration-200 hover:-translate-y-1 cursor-pointer hover:text-black/70"
                        >
                        ...
                        <svg
                            viewBox="0 0 960 1000"
                            fill="currentColor"
                            className="face w-10 h-10 transition-all duration-200 hover:-translate-y-1 cursor-pointer hover:text-black/70"
                            >
                        ...
                        <svg
                            viewBox="0 0 960 1000"
                            fill="currentColor"
                            className="linked w-10 h-10 transition-all duration-200 hover:-translate-y-1 cursor-pointer hover:text-black/70"
                        >
